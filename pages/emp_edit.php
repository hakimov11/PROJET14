...
$opt .= "</select>";
        ...
        $query = 'SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, RIB, PHONE_NUMBER, j.JOB_TITLE, HIRED_DATE, l.PROVINCE, l.CITY FROM employee e join location l on l.LOCATION_ID=e.LOCATION_ID join job j on j.JOB_ID=e.JOB_ID WHERE EMPLOYEE_ID ='.$_GET['id'];
        $result = mysqli_query($db, $query) or die(mysqli_error($db));
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <form role="form" method="post" action="emp_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="RIB" name="RIB" value="<?php echo $RIB; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
