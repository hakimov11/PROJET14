...
<?php
  ...
  $query = 'SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,GENDER, RIB, PHONE_NUMBER, j.JOB_TITLE, HIRED_DATE, l.PROVINCE, l.CITY FROM employee e join location l on e.LOCATION_ID = l.LOCATION_ID join job j on j.JOB_ID=e.JOB_ID WHERE e.EMPLOYEE_ID ='.$_GET['id'];
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
