...
$opt .= "</select>";
        ...
        $query = "SELECT ID, e.FIRST_NAME, e.LAST_NAME, e.GENDER, USERNAME, PASSWORD, e.rib, PHONE_NUMBER, j.JOB_TITLE, e.HIRED_DATE, t.TYPE, l.PROVINCE, l.CITY
                      FROM users u
        ...
        <div class="modal-body">
          <form role="form" method="post" action="settings_edit.php">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="RIB" name="RIB" value="<?php echo $f; ?>" required>
                </div>
              </div>
              <div class="form-group row text-left text-primary">
                <div class="col-sm-3" style="padding-top: 5px;">
